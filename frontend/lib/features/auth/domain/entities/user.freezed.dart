...
class _$UserImpl implements _User {
  ...
  @override
  String toString() {
    return 'User(id: $id, name: $name, email: $email, defaultCurrency: $defaultCurrency, avatarUrl: $avatarUrl)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, name, email, defaultCurrency, avatarUrl);
